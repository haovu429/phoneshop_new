...
public class Config {
    ...
    public static String vnp_Returnurl = "/vnpay_jsp/vnpay_return.jsp";
    public static String vnp_TmnCode = "K1N5JSP8";
    public static String vnp_HashSecret = "WUQWKLJTQKMTHOOJBKACUZMMZDTPCUIR";
